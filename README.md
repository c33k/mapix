...
- [ ] add color picker (at the moment, user can only select 9 colors), enabling user to choose any color he wants. This require us to add a module on Mapix to export the set of unique used colors to a .png file (ie. sprite!)
